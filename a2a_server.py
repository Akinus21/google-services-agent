...
def _tool_defs():
    return [
        ...
        },
        {
            "id": "gmail_star",
            "name": "Gmail Star",
            "description": "Star or unstar a message. Arguments: message_id (string, required), starred (boolean, optional, default true — pass false to unstar).",
            "tags": ["gmail", "write"],
            "available": google_configured(),
        ...
        },
        {
            "id": "gmail_trash",
            "name": "Gmail Trash",
            "description": "Move a message to Trash (reversible for ~30 days — NOT permanent delete, which is out of scope for this agent). Arguments: message_id (string, required).",
            "tags": ["gmail", "write"],
            "available": google_configured(),
        ...
        },
        {
            "id": "gmail_untrash",
            "name": "Gmail Untrash",
            "description": "Restore a message out of Trash. Arguments: message_id (string, required).",
            "tags": ["gmail", "write"],
            "available": google_configured(),
